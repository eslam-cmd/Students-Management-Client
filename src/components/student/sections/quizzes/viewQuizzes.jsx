...
export default function ViewQuizByMonth() {
  ...
  // ✅ جلب الاختبارات النظرية بالاعتماد المباشر على كوكي الجلسة الحالية
  const fetchQuiz = useCallback(async () => {
    ...
    try {
      ...
      // تصفية الاختبارات النظرية فقط
      return studentQuizzes.filter((q) => q.type === "theory");
    } catch (err) {
      console.error("Theory quiz fetch error:", err);
      return [];
    } finally {
      setLoading(false);
    }
