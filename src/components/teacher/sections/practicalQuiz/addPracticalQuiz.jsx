// src/components/AddPracticalQuiz.jsx
"use client";
...
const AddPracticalQuiz = () => {
  ...
  const validate = () => {
    ...
    if (!quizData.quiz_grade.trim())
      newErrors.quiz_grade = "Student grade is required";
    if (!quizData.quiz_date) newErrors.quiz_date = "Quiz date is required";
    if (!quizData.student_id) newErrors.student_id = "Please select a student";
    if (!quizData.quiz_name) newErrors.quiz_name = "Subject name is required";
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitError("");
    try {
      const res = await fetch(`${API}/api/practical-quiz`, {
        method: "POST",
