...
export default function ViewExams() {
  ...
  const validateEdit = () => {
    const errs = {};
    if (!editData.sabject_title.trim()) errs.sabject_title = "Title required";
    if (!editData.sabject_name) errs.sabject_name = "Select subject";
    if (!editData.sabject_date) errs.sabject_date = "Date required";
    if (!editData.sabject_grade.toString().trim())
      errs.sabject_grade = "Grade required";
    setEditErrors(errs);
